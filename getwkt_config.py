...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'getwkt_config_base.ui'))

class getwktConfig(QtWidgets.QDialog, FORM_CLASS):
    """"Setup variables"""
    s = QgsSettings()
    """Get dialog class"""
    def __init__(self, parent=None):
        """Constructor."""
        super(getwktConfig, self).__init__(parent)
        self.setupUi(self)
        ...
        #Load saved settings
        dpmethod = self.s.value("getwkt/dpmethod")
        if dpmethod == 'auto':
        ...
        #Custom value
        val = self.s.value("getwkt/dpcustom")
        if not val:
            val = 10
        ...
        tool = self.s.value("getwkt/toolmethod")
        ...
        if not multiselecttype:
            ...
            self.s.setValue("getwkt/multiselecttype", multiselecttype)
    ...
    def setupUi(self, Dialog):
        ...
        super(getwktConfig, self).setupUi(Dialog)
    ...
    def tool_handleDefaultChange(self, value):
        ...
        #Update dp setting
        self.s.setValue("getwkt/toolmethod", self.tool_cmbDefault.currentText())
    
    def dp_handleChange(self, t):
        """Handle change to dp method"""
        #Update dp setting
        self.s.setValue("getwkt/dpmethod", t)
    ...
    def dp_handleChange_CustomValue(self):
        ...
        self.s.setValue("getwkt/dpcustom",value)
    ...
    def ms_handleMultiSelectChange(self, state):
        ...
        self.s.setValue("getwkt/multiselect", ms_enabled)
    ...
    def ms_handleChange(self, t):
        """Handle change to dp method"""
        #Update dp setting
        self.s.setValue("getwkt/multiselecttype", t)
    ...
    def srs_handleChange_SRID(self):
        ...
        try:
            ...
            value = -1
        self.s.setValue("getwkt/srid",value)